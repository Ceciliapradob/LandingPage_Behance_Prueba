  ...
  return (
    <header>
      <nav className="flex items-center justify-around h-[50px] mt-[10px] mx-[50px] ml-[100px]">
        {/* Logo */}
        <a href="#home" className="ml-[70px]">
          {/* <img src={logo} alt="logo" className="w-[45px] h-[15px]" /> */}
          <span>Logo</span>
        </a>

        {/* Menú principal */}
        <div className="hidden md:flex items-center gap-[25px] mr-[80px]">
          <ul className="flex gap-[35px] ">
            <li>
              <a
                href="#home"
                className="no-underline text-[#212122] text-[12px] font-bold"
              >
                HOME
              </a>
            </li>
          ...
          <a href="#" className="mr-[30px]">
            <button
              className="
             text-[#FF014F] text-[12px] font-bold 
             w-[100px] h-[35px] 
             bg-gradient-to-br from-[#E2E8EC] to-[#FDFDFE] 
             rounded-[5px] border-none 
             shadow-[-10px_-10px_10px_-5px_white] 
             cursor-pointer
             transition-all duration-300 ease-in-out
             hover:shadow-[-5px_-5px_10px_-3px_white]
